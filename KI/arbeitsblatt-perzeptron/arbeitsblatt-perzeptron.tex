...
\begin{quote}
Berechne $z = w_0 + w_1 x_1 + w_2 x_2$\\
\textbf{Falls} $y \cdot z \leq 0$ \quad (Fehlklassifikation):
\begin{quote}
$w_0 \leftarrow w_0 + y$\\
$w_1 \leftarrow w_1 + y \cdot x_1$\\
$w_2 \leftarrow w_2 + y \cdot x_2$
\end{quote}
\end{quote}
\end{quote}
...
\medskip
\noindent \textbf{c)} Führen Sie bei Bedarf weitere Epochen durch, bis keine Fehlklassifikation mehr auftritt. Notieren Sie die Endgewichte:

\medskip
$w_0 = \underline{\hspace{1.5cm}}, \quad w_1 = \underline{\hspace{1.5cm}}, \quad w_2 = \underline{\hspace{1.5cm}}$
...
\hline
Ausgabe / Vorhersage & Das Vorzeichen von $z$. Die vom Neuron vorhergesagte Klasse ($+1$ oder $-1$). \\
\hline
Fehlklassifikation & Tritt auf, wenn $y \cdot z \leq 0$ gilt, also wenn Vorhersage und wahre Klasse nicht übereinstimmen (oder $z = 0$ ist). \\
\hline
\end{tabular}
\end{center}
